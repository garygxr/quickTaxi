package com.gary.common.security.auth;
...
public class AuthLogic
{
     ...
     * @return 用户缓存信息
     */
    public AuthUser getLoginUser(String uid)
    {
        return tokenService.getAuthUserByUid(uid);
    }
     ...
     */
    public void verifyLoginUserExpire(AuthUser loginUser)
    {
